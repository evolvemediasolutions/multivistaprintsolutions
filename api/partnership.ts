...
export default async function handler(req: any, res: any) {
  ...
  console.log(`Vercel function received partnership submission from ${name} (${company})`);
  ...
  try {
    ...
    if (sql) {
      ...
      console.warn('Neon Database connection string is not configured on Vercel.');
    }
    ...
    if (resend) {
      ...
      console.warn('Resend API key is not configured on Vercel.');
    }
